<?php
	...
	if(server=="poorvi"){
		...
		define('ROOT', '/home/btech/cs1120233/private_html/rahul/', false);
		...
		define('HOST','http://localhost/rahul/',false); // false mean that HOST cannot be used as hOsT
		define('ROOT', '/var/www/rahul/', false);
		define('CDN', HOST.'photo/', false);
		if(false){
			$db_data = array() ;
		...
		define('HOST','http://54.149.49.212/rahul/',false); // false mean that HOST cannot be used as hOsT
		define('ROOT', '/var/www/html/rahul/', false);
		define('CDN', HOST.'photo/', false);
		$db_data = array() ;
		$db_data['host'] = 'localhost' ;
		$db_data['user'] = 'root' ;
